...
function calc() {
  ...
  initLocalSettings(".calculating__choose_big div", "calculating__choose-item_active"); // checks if any of the variables false then get ____ in span
...
function card() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResorces)("http://localhost:3000/menu").then(function (data) {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      form.insertAdjacentElement("afterend", statusMessage); // if type data is formdate dont need to set request header
      // request.setRequestHeader("Content-type", "multipart/form-data");
      // request.setRequestHeader("Content-type", "application/json");

      var formData = new FormData(form); // convert form data for json
      // const object = {};
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // request.send(json);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)(".modal", modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_7__.closeModal)(".modal");
    }, 4000);
...
function openModal(modalSelector, modalTimerId) {
  ...
  console.log(modalTimerId); // check if modalTimerId was created, only then removing it after xxx time
...
function closeModal(modalSelector) {
  var modal = document.querySelector(modalSelector); // had to use inline style as classes didnt work
...
function slider(_ref) {
  ...
  function checkSliderLength() {
    if (currentPossition < 10) {
      currentSlider.textContent = "0".concat(currentPossition);
    } else {
  ...
  if (offerSlider.length < 10) {
    totalSlider.textContent = "0".concat(offerSlider.length);
    currentSlider.textContent = "0".concat(currentPossition);
  } else {
  ...
  slidesField.style.transition = "0.5s all"; // anything that doesnt fit the container should be "hidden"

  offerSliderWrapper.style.overflow = "hidden"; // setting up width of all slides in slider to the set parameter "width"

  offerSlider.forEach(function (slide) {
    slide.style.width = width;
  });
  slider.style.position = "relative"; // Creating new "Ordered list",
  ...
  var dotWrapper = document.createElement("ol"),
      dots = [];
  ...
  rightArrow.addEventListener("click", function () {
    ...
    slidesField.style.transform = "translateX(-".concat(offset, "px)"); // if you are at 4 and clicking right set number to 1
    ...
    checkSliderLength(); // sets opacity of all dots to 0,5 apart from the one which matches
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    tabsContent[i].classList.remove("hidden"); // dont add . because classList already knows its class
  ...
  tabsParent.addEventListener("click", function (event) {
    var target = event.target; // since we use classlist method we cant pass just selector with dot we need to remove dot
...
function timer(id, deadLine) {
  ...
  function getTimeRemaining(endtime) {
    ...
    hours = Math.floor(t / (1000 * 60 * 60) % 24),
        ...
        seconds = Math.floor(t / 1000 % 60); // returning as OBJECT
  ...
  function setClock(selector, endtime) {
    var timer = document.querySelector(selector),
        ...
        timeInterval = setInterval(updateClock, 1000); // when setclock runs it it will wait 1 second to update the clock
...
/* harmony export */   "getResorces": function() { return /* binding */ getResorces; }
/* harmony export */ });
...
var getResorces = /*#__PURE__*/function () {
  ...
  return function getResorces(_x3) {
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)(".modal", modalTimerId);
  }, 500000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2022-01-01"); // end of documentContentLoaded
